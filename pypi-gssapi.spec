...
Source0  : https://files.pythonhosted.org/packages/04/2f/fcffb772a00e658f608e657791484e3111a19a722b464e893fef35f35097/gssapi-1.9.0.tar.gz
...
%prep
%setup -q -n gssapi-1.9.0
cd %{_builddir}/gssapi-1.9.0
pushd ..
cp -a gssapi-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728490425

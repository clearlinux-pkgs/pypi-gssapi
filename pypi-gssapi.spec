...
Provides: gssapi
Provides: gssapi-python
Provides: gssapi-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641441439
...
cp %{_builddir}/gssapi-1.7.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-gssapi/dcebddb4fa716078a910d0fa8b5761106c76738e
